...
- **`AGENTS.md`**, **`.claude/CLAUDE.md`**, **`commands/setup.md`**, **`commands/view.md`**, **`docs/agents.md`**, **`docs/index.md`**, **`docs/setup/claude-code.md`**, **`docs/setup/kimi-code.md`**, **`docs/setup/opencode.md`** — the agent count said 16 in nine places and 17 in six others, against 17 files actually shipped in `agents/` since v8.0.0 took the count from 14 to 17. `/kairos:setup` copies files by that number, so the low count was not only cosmetic. All of them now say 17, and the home page's feature card, which listed the agents by name, had been missing QA Plan Agent since 8.0.0.
