...
├── .opencode/agents/     ← OpenCode mirror of the 16 core agents above (see Setup > OpenCode)
└── .kimi-code/agents/    ← Kimi Code mirror of the 16 core agents above (see Setup > Kimi Code)
```
