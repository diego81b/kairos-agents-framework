...
You are configuring which models the 16 KAIROS core pipeline agents will use in this project. Work through the steps below in order, and never touch anything outside them.
...
Print the resulting 16-row table (agent → model). Then remind the user:
