...
Follow [`issue-tracker-comment`](../skills/issue-tracker-comment/SKILL.md) — `{output_file}: 07-retrospective.md`, `{title}: ## Retrospective`, plain body. Post only the `## What To Do Differently` section, not the whole file.
